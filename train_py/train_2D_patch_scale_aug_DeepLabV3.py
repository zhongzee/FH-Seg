...
def get_arguments():
    ...
    parser.add_argument("--snapshot_dir", type=str, default='snapshots_2D/DeepLabV3/fold1_with_white_scale_normalwhole_1217/')
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        model = deepv3.DeepV3R50(6, criterion=criterion)
        check_wo_gpu = 0
            ...
            if (epoch >= 0) and (args.local_rank == 0) and (((epoch % 10 == 0) and (epoch >= 800)) or (epoch % 1 == 0)):
                ...
                with torch.no_grad():
                    for iter, batch in enumerate(valloader):
                        ...
                        output_folder = os.path.join(args.snapshot_dir.replace('snapshots_2D/fold1_with_white',  '/data2/DoDNet/MIDL/DeepLabV3/HC_validation'), str(epoch))
