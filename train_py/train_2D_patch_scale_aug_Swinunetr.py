...
def get_arguments():
    ...
    parser.add_argument("--snapshot_dir", type=str, default='snapshots_2D/Swinunetr/fold1_with_white_scale_normalwhole_1217/')
            ...
            if (epoch >= 0) and (args.local_rank == 0) and (((epoch % 10 == 0) and (epoch >= 800)) or (epoch % 1 == 0)):
                ...
                with torch.no_grad():
                    for iter, batch in enumerate(valloader):
                        ...
                        output_folder = os.path.join(args.snapshot_dir.replace('snapshots_2D/fold1_with_white',  '/data2/DoDNet/MIDL/Swinunetr/HC_validation'), str(epoch))
