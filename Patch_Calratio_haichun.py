...
def scn_to_png(svs_file,annotation_xml_file, output_dir,lv,t, csv_list, segmentation_list, big_img_list):
    for ci in range(len(csv_list)):
        now_csv = pd.read_csv(csv_list[ci])
        'get each boundary of slice and match the detection results'

        patch_output_folder = os.path.join(output_folder, os.path.basename(csv_list[ci]).replace('.csv', ''))
        ...
        for ki in range(len(now_csv)):
            ...
            # now_name = '%03d_%s_%s_%s.png' % (ind, Gene, x, y)
            # now_seg_name = '%03d_%s_%s_%s.png_preds.png' % (ind, Gene, x, y)
            # now_seg = plt.imread(os.path.join(patch_output_folder, now_seg_name))[:,:,:3]

            now_seg_name = glob.glob(os.path.join(patch_output_folder, '*_%s_%s_%s.png_preds.png' % (Gene, x, y)))[0]
        ...
        AI_ratio.to_csv(os.path.join(patch_output_folder,'ratio_%s.csv' % (os.path.basename(patch_output_folder))), index = False)
...
if __name__ == "__main__":
    ...
    output_dir = '/Data2/HumanKidney/Omni-Seg_revision/Patch_ratio_all_OmniSeg_scale_#7_cap256to256'
    #output_dir = '/media/dengr/Seagate Backup Plus Drive/OmniSeg+TableResults/Patch_all_Omni-Seg+/Patch_ratio_haichun_OmniSeg_scale_No1_cap512to256_id0'
    # circlenet_folder = '/Data2/HumanKidney/Mouse_Atubular/CircleNet'
    #
    big_img_list = ['/Data2/HumanKidney/Mouse_Atubular_Segmentation/V11M25-279/20X/V11M25-279_1.png',
                    '/Data2/HumanKidney/Mouse_Atubular_Segmentation/V11M25-279/20X/V11M25-279_2.png',
                    '/Data2/HumanKidney/Mouse_Atubular_Segmentation/V11M25-279/20X/V11M25-279_3.png',
                    '/Data2/HumanKidney/Mouse_Atubular_Segmentation/V11M25-279/20X/V11M25-279_4.png']


    segmentation_list = ['/Data2/HumanKidney/OmniSeg_testing/Quantification_overlap/final_merge_Med3D/V11M25-279_1',
                         '/Data2/HumanKidney/OmniSeg_testing/Quantification_overlap/final_merge_Med3D/V11M25-279_2',
                         '/Data2/HumanKidney/OmniSeg_testing/Quantification_overlap/final_merge_Med3D/V11M25-279_3',
                         '/Data2/HumanKidney/OmniSeg_testing/Quantification_overlap/final_merge_Med3D/V11M25-279_4']

    # csv_list = ['/Data2/HumanKidney/Mouse_Atubular_GenePatch/MouseGeneCoords/6793-AF-7.glomeruli.csv', '/Data2/HumanKidney/Mouse_Atubular_GenePatch/MouseGeneCoords/6793-AF-8.glomeruli.csv',
    #             '/Data2/HumanKidney/Mouse_Atubular_GenePatch/MouseGeneCoords/6793-AF-9.glomeruli.csv', '/Data2/HumanKidney/Mouse_Atubular_GenePatch/MouseGeneCoords/6793-AF-10.glomeruli.csv']



    csv_list = ['/Data2/HumanKidney/Mouse_Atubular/Haichun_MouseGeneCoords/6793-AF-7.glomeruli.csv',
                '/Data2/HumanKidney/Mouse_Atubular/Haichun_MouseGeneCoords/6793-AF-8.glomeruli.csv',
                '/Data2/HumanKidney/Mouse_Atubular/Haichun_MouseGeneCoords/6793-AF-9.glomeruli.csv',
                '/Data2/HumanKidney/Mouse_Atubular/Haichun_MouseGeneCoords/6793-AF-10.glomeruli.csv']
    ...
    for si in range(len(sections)):
        ...
        scn_to_png(now_section, now_annotation_xml, output_folder, lv, si, csv_list, segmentation_list, big_img_list)
