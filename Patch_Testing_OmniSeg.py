...
def get_arguments(img, output_folder):
    ...
    # N07
    parser.add_argument("--snapshot_dir", type=str, default='snapshots_2D/fold1_with_white_ns_psuedo_allMatching_withsemi_0.1_0.1_normalwhole_0902')
    parser.add_argument("--reload_path", type=str, default='snapshots_2D/fold1_with_white_ns_psuedo_allMatching_withsemi_0.1_0.1_normalwhole_0902/MOTS_DynConv_fold1_with_white_ns_psuedo_allMatching_withsemi_0.1_0.1_normalwhole_0902_e97.pth')
    parser.add_argument("--best_epoch", type=int, default=97)
...
if __name__ == '__main__':
    ...
    output_dir = '/Data2/HumanKidney/Omni-Seg_revision/Patch_ratio_all_OmniSeg_#8_cap256to256/V11M25-279'
