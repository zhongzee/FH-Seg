...
# train_2D_patch_scale_aug_FH_Seg_for_6class_1GPU_2K/
import skimage
...
def get_arguments():
    ...
    parser.add_argument("--valset_dir", type=str, default='./data/LRV/test/data_list.csv')
    ...
    parser.add_argument("--exname", type=str,
                        default='train_2D_patch_scale_aug_FH_Seg_for_6class_1GPU_2K')  # 日志存储名字
    parser.add_argument("--snapshot_dir", type=str, default='snapshots_2D/FH_Seg/train_2D_patch_scale_aug_FH_Seg_for_6class_1GPU_2K/')
    ...
    parser.add_argument("--reload_path", type=str,
                        default="snapshots_2D/FH_Seg/train_2D_patch_scale_aug_FH_Seg_for_6class_1GPU_2K/MOTS_DynConv_train_2D_patch_scale_aug_FH_Seg_for_6class_1GPU_2K_e65.pth")
    ...
    parser.add_argument("--train_list", type=str, default='./data/LRV/train/data_list.csv')
    ...
    parser.add_argument("--val_list", type=str, default='./data/LRV/train/test/data_list.csv')
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        #              batch_norm=True)
        model = UNet2D_scaleAttentionFullscale(num_classes=6, weight_std=False)  # 消融实验
        ...
        for epoch_i in range(151, 152):
            ...
            with torch.no_grad():
                for iter, batch in enumerate(valloader):
                    ...
                    ###For Human
                    # output_folder = os.path.join('/data2/DoDNet/MIDL/Test_for_MH2H_FH_Seg_10class/Validation_%s' % (args.validsetname), str(args.best_epoch))
                    output_folder = os.path.join(
                        '/root/autodl-tmp/Omni-Seg_revision/experiments_validation/FH_Seg/' + args.exname + '/validation_scale_0730',
                        str(args.best_epoch))
                    ###For Mice
