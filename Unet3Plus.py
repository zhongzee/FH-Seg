...
from utils.layers import unetConv2
...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=6, feature_scale=4, is_deconv=True, is_batchnorm=True):
    ...
    def forward(self, inputs):
        ## -------------Encoder------------- #inputstorch.Size([1, 3, 512, 512])
        ...
        hd4 = self.relu4d_1(self.bn4d_1(self.conv4d_1(
            torch.cat((h1_PT_hd4, h2_PT_hd4, h3_PT_hd4, h4_Cat_hd4, hd5_UT_hd4), 1))))  # hd4->40*40*UpChannels # torch.Size([1, 320, 64, 64])
        ...
        hd3 = self.relu3d_1(self.bn3d_1(self.conv3d_1(
            torch.cat((h1_PT_hd3, h2_PT_hd3, h3_Cat_hd3, hd4_UT_hd3, hd5_UT_hd3), 1))))  # hd3->80*80*UpChannels # torch.Size([1, 320, 128, 128])
        ...
        hd2 = self.relu2d_1(self.bn2d_1(self.conv2d_1(
            torch.cat((h1_PT_hd2, h2_Cat_hd2, hd3_UT_hd2, hd4_UT_hd2, hd5_UT_hd2), 1))))  # hd2->160*160*UpChannels #  torch.Size([1, 320, 256, 256])
        ...
        hd1 = self.relu1d_1(self.bn1d_1(self.conv1d_1(
            torch.cat((h1_Cat_hd1, hd2_UT_hd1, hd3_UT_hd1, hd4_UT_hd1, hd5_UT_hd1), 1))))  # hd1->320*320*UpChannels # torch.Size([1, 320, 512, 512])

        d1 = self.outconv1(hd1)  # d1->320*320*n_classes
        return F.sigmoid(d1) # torch.Size([1, 6, 512, 512])
